...
async def verify_page(request):
    ...
    </head><body><div class="box"><h1>✅ Doğrulama Başarılı!</h1><p>Üyeliğiniz onaylandı. Şimdi Telegram botuna geri dönerek <b>/start</b> yazabilir ve VIP Radarı açabilirsiniz.</p></div></body></html>"""
